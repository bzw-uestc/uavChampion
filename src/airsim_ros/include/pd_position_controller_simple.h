...
public:
    ...
    PIDParams()
        : kp_x(1.5), kp_y(1.5), kp_z(3.0), kp_yaw(0.5), kd_x(1.0), kd_y(1.0), kd_z(1.0), kd_yaw(0.2), reached_thresh_xyz(0.5), reached_yaw_degrees(0.5)
    {
    }
...
public:
    ...
    DynamicConstraints()
        : max_vel_horz_abs(5.0), max_vel_vert_abs(5.0), max_yaw_rate_degree(1)
    {
    }
