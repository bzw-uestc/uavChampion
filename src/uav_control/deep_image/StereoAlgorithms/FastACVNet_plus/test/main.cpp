...
int main()
{
    ...
    char* stereo_calibration_path="/home/uestc/mingwei/StereoAlgorithms/FastACVNet_plus/test/StereoCalibrationUAV.yml";
    char* strero_engine_path="/home/uestc/mingwei/StereoAlgorithms/FastACVNet_plus/test/fast_acvnet_plus_generalization_opset16_480x640.onnx";
    ...
    {
        // imageL=cv::imread("/home/uestc/uavChampion/left/" + std::to_string(i) +".jpg" );
        // imageR=cv::imread("/home/uestc/uavChampion/right/" + std::to_string(i) +".jpg");
        imageL=cv::imread("/home/uestc/mingwei/StereoAlgorithms/FastACVNet_plus/test/im0.jpg");
        imageR=cv::imread("/home/uestc/mingwei/StereoAlgorithms/FastACVNet_plus/test/im1.jpg");
        pointcloud=new float[imageL.cols*imageL.rows*6];
