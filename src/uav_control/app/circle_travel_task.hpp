...
#define MAX_VEL_FAST_FAST 5.0
#define MAX_VEL_FAST 5.0
#define MAX_VEL_MID 5.0
#define MAX_VEL_SLOW 5.0
...
#define MAX_ACC_FAST_FAST 10.0     
#define MAX_ACC_FAST 10.0
#define MAX_ACC_NORMAL 10.0
...
private:
    ...
    ros::Publisher desire_yaw_pub_,desire_pitch_pub_,desire_roll_pub_;
    ros::Publisher odom_yaw_pub_,odom_pitch_pub_,odom_roll_pub_;
    ...
    Eigen::Vector3d drone_odom_euler_; //无人机odom的欧拉角
